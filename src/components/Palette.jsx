...
//   return (
//    <>
//    <div id="needUpdate" className={`flex bg-white w-64 h-20 rounded-sm border-l-[4px] border-black`}>
...
//       </span>
//       <span id = "hello" className={`m-auto rounded-full p-[14px] ml-auto mr-[30px] `}><i>{props.icon}</i></span>
//    </div>
//    </>
//   )
// }
